...
layui.use(['layer','element','jquery'],function() {
    ...
    $('.left-nav #nav').on('click', 'li', function(event) {
        ...
        $('.left-nav').find('a').removeClass('active');
        if($('.layui-this').text()=='数据管理ဆ')
        {
          $('.image_manage').children('a').addClass('active');
        }
        else if($('.layui-this').text()=='设备管理ဆ')
        {
          $('.equip_manage').children('a').addClass('active');
        }
        else if($('.layui-this').text()=='信息导出ဆ')
        {
          $('.out_info').children('a').addClass('active');
        }
        else
        {
          $('.user_manage').children('a').addClass('active');
        }
    ...
    $('.page-content .layui-tab-title li').click(function(event) {
      $('.left-nav').find('a').removeClass('active');
      if($(this).text()=='数据管理ဆ')
      {
        $('.image_manage').children('a').addClass('active');
      }
      else if($(this).text()=='设备管理ဆ')
      {
        $('.equip_manage').children('a').addClass('active');
      }
      else if($(this).text()=='信息导出ဆ')
      {
        $('.out_info').children('a').addClass('active');
      }
      else
